...
const CACHE = 'melody-miracle-20260819.3';

// Per-file version strings — must match exactly what index.html and app.js request.
const V_APP  = '20260819.3'; // app.js (nav row: show/hide whole row; prev/next disabled at boundaries)
...
const V_CSS  = '20260819.1'; // style.css (mbhajan-footer: nav row on own line below actions)
