...
const CACHE = 'melody-miracle-20260815.9';

// Per-file version strings — must match exactly what index.html and app.js request.
const V_APP  = '20260815.9'; // app.js (fix host-for-everyone bug; subtle observer row)
const V_GH   = '20260811.1'; // github-store.js (unchanged)
const V_CSS  = '20260815.9'; // style.css (observer-banner → observer-meta strip)
