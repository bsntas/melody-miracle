...
const CACHE = 'melody-miracle-20260817.17';

// Per-file version strings — must match exactly what index.html and app.js request.
const V_APP  = '20260817.17'; // app.js (series list redesign: cards with accent stripe, visible delete icon, session count)
const V_GH   = '20260817.14'; // github-store.js (addSeries + _commitSeriesIndex includes _knownSeries)
const V_CSS  = '20260817.5'; // style.css (series cards redesign)
