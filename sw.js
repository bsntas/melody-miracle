...
const CACHE = 'melody-miracle-20260817.18';

// Per-file version strings — must match exactly what index.html and app.js request.
const V_APP  = '20260817.18'; // app.js (series cards: ··· button reveals delete; no always-visible trash)
const V_GH   = '20260817.14'; // github-store.js (addSeries + _commitSeriesIndex includes _knownSeries)
const V_CSS  = '20260817.6'; // style.css (series-card-secondary slide, series-more-btn)
